...
namespace NoorTrust.DonationFund.WebUI.Controllers
{
    ...
    public class SecurityAdminController : Controller
    {
        ...
        private List<ClaimViewModel> GetAllClaims()
        {
            ...
            foreach (var president in _SponsorService.GetSponsors())
            {
        ...
        private List<SelectListItem> AdaptToSelectListItems(IList<Sponsor> fromValues)
        {
            List<SelectListItem> toValues = new List<SelectListItem>();
        ...
        //{
        //    await _TestDataUtility.CreateSponsorTestData();
